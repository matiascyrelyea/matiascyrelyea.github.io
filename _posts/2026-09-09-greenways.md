...
<p> Greenways really are nice. If we can incentivize car-centric American cities to construct greenways, why can't we incentivize mathematicians to be infinitely more community-oriented and build a program to face (but not fight against) the artificial intelligence problem? </p>
