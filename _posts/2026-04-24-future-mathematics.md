...
> The problem with unintelligible mathematics isn't that it might be <i>false</i>. It is that it is literally <i>meaningless</i>, in the sense that it doesn't compile on the only hardware that is currently able to <i>make sense of it</i> and <i>appreciate its value</i>—the human brain. 
>
> <br>
>
> — David Bessis
